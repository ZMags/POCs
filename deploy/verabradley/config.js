...
var commerceProjectName_zmag = 'POC_verabradley100811PO';
...
var getProdDetailBaseURL_zmag = "http://psdev.zmags.com/poc/deploy/verabradley/100811/productDetail.php";
var addToCartButtonID_zmag = 'addToCartBtn';
var addToCartConfirmHTML_zmag = '<div align="center" id="cartConfirm"><br><button class="checkout" onclick="zmags_redirectToCart(\'http://www.verabradley.com/checkout/basket.jsp\')"></button><button class="continue" onclick="closeProductWindow_zmag()"></button></div>';
...
*/
var includePathZmags ='http://psdev.zmags.com/poc/deploy/verabradley/100811/';
